    ...
    try:
        ...
        with mydb.cursor() as cursor:
            ...
            if count > 0: # This sends a graph to ALL PAX who have attended at least 1 beatdown
                ...
                slack.chat.post_message(user_id_tmp, 'Hello ' + pax + '! Here is a quick look at your posting stats since I started tracking (mid-Sept). If you think there are discrepancies, contact @Beaker for help. You have only 2 more days to get some October numbers in, make them count!')
