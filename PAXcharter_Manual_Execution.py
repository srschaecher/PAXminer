...
try:
    with mydb1.cursor() as cursor:
        sql = "SELECT * FROM paxminer.regions where region = 'KC' and firstf_channel IS NOT NULL AND send_firstf_messages = 1" # <-- Update this for whatever region is being tested
        cursor.execute(sql)
